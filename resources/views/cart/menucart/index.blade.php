...
<main>
	...
	<div class="page-area cart-page spad">
		<div class="container">
            ...
            <tr>
							<td >
                <img src="{{ asset('image/product_photo') }}/{{ App\Product::find($cart_item->product_id)->product_image }}" alt="" width="80">
								<div class="pc-title">
									<h3>{{ App\Product::find($cart_item->product_id)->name}}</h3>
									<a href="{{ url('delete/from/cart') }}/{{ $cart_item->id  }}" ><b>Delete Product</b></a>
								</div>
							</td>

							<td class="price-col">৳{{ App\Product::find($cart_item->product_id)->price}}
                <input type="hidden" id="price" value="{{ App\Product::find($cart_item->product_id)->price}}">
              </td>

							<td class="quy-col">
								<div class="quy-input">
									<span>Qty</span>
									<input id="qty" type="number" value="{{$cart_item->product_quantity}}">
								</div>
							</td>
			...
			<div class="row cart-buttons">
				...
				<div class="col-lg-3">
					<a href="{{ route('homepage') }}"><div class="site-btn btn-continue">Continue shooping</div></a>
				</div>

				<div class="col-lg-2  text-lg-right text-left">
					<a href="{{ route('cart_clear')}}"><div class="site-btn btn-clear">Clear cart</div></a>
				</div>

        <div class="col-lg-2 ">
					<div id="sub_total" class="site-btn btn-continue">Total = ৳ {{ $sub_total  }} </div>
				</div>


        <div class="col-lg-2 ">
					<a href="{{ route('checkout')}}"><div class="site-btn btn-clear"> Checkout </div></a>
				</div>

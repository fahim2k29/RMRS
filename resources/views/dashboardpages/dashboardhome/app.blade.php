...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="topbar">
            <!-- LOGO -->
            <div class="topbar-left"><a href="index.html" class="logo"><span><img src="{{ ('backend/assets/images/logo-light.png') }}" alt="" height="18"> </span><i><img src="{{ ('backend/assets/images/logo-sm.png') }}" alt="" height="22"></i></a></div>
              ...
              <ul class="navbar-right list-inline float-right mb-0">
                  ...
                  <!-- <li class="dropdown notification-list list-inline-item">
                      <div class="dropdown notification-list nav-pro-img">
                          <a class="dropdown-toggle nav-link arrow-none waves-effect nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false"><img src="{{ asset('backend/assets/images/users/user-4.jpg') }}" alt="user" class="rounded-circle"></a>
            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <!-- <li><a href="{{ route('dashboard') }}" class="waves-effect"><i class="ti-home"></i><span class="badge badge-primary badge-pill float-right"></span> <span>User</span></a></li>

                          <li><a href="{{ route('order') }}" class="waves-effect"><i class="ti-gift"></i><span> Order</span></a></li> -->

                <!-- employee -->
                              <li><a href="{{ route('employee_table') }}" class="waves-effect "><i class="ti-home"></i><span class="badge badge-primary badge-pill float-right"></span> <span>Employee</span></a></li>

                <!-- Product -->
                          <li><a href="{{ route('product') }}" class="waves-effect "><i class="ti-home"></i><span class="badge badge-primary badge-pill float-right"></span> <span> Product </span></a></li>

                          <li><a href="{{ route('query') }}" class="waves-effect"><i class="ti-gift"></i><span> Query</span></a></li>


                          <li><a href="{{ route('food_type') }}" class="waves-effect"><i class="ti-gift"></i><span> FoodType</span></a></li>

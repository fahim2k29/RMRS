            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li><a href="<?php echo e(route('employeeinfo')); ?>" class="waves-effect text-light"><span class="badge badge-primary badge-pill float-right"></span> <span> Add Employee Info</span></a></li>
                        <li>
                              ...
                              <a href="<?php echo e(route('employee_table')); ?>" class="fas fa-folder"><span> Personal</span></a>
                              <a href="<?php echo e(route('employeeinfo_contact')); ?>" class="fas fa-folder">Contact</a>
                              <a href="<?php echo e(route('employeeinfo_emergency')); ?>" class="fas fa-folder">Ememrgency</a>
                              <a href="<?php echo e(route('jobInfo')); ?>"  class="fas fa-folder">Job related</a>
                              </div>
                              </div>
                        </li>
...
<?php /**PATH C:\Users\Rimu360\Downloads\NewProject-master-master-20191231T163411Z-001\NewProject-master-master\resources\views/employee/app.blade.php ENDPATH**/ ?>
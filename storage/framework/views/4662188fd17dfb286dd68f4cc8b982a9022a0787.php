...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group row">
                                  <label for="name" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Food Type')); ?></label>
                                    <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group row">
                                  <label for="stock_quantity" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Stock Quantity')); ?></label>
                                  <div class="col-md-6">
...
<?php echo $__env->make('product.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\NewProject-master-master\NewProject-master-master\resources\views/product/product_list/create.blade.php ENDPATH**/ ?>
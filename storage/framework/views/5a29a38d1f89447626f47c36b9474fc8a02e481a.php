...
<main>
	...
	<div class="page-area cart-page spad">
		<div class="container">
            ...
            <tr>
                ...
                <img src="<?php echo e(asset('image/product_photo')); ?>/<?php echo e(App\Product::find($cart_item->product_id)->product_image); ?>" alt="" width="80">
							...
							<td class="price-col">৳<?php echo e(App\Product::find($cart_item->product_id)->price); ?>

                <input type="hidden" id="price" value="<?php echo e(App\Product::find($cart_item->product_id)->price); ?>">
              </td>

							<td class="quy-col">
								<div class="quy-input">
									<span>Qty</span>
									<input id="qty" type="number" value="<?php echo e($cart_item->product_quantity); ?>">
								</div>
							</td>
        ...
        <div class="col-lg-2 ">
					<div id="sub_total" class="site-btn btn-continue">Total = ৳ <?php echo e($sub_total); ?> </div>
				</div>
...
<?php echo $__env->make('frontpage.homepage.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rimu360\Downloads\NewProject-master-master-20191231T163411Z-001\NewProject-master-master\resources\views/cart/menucart/index.blade.php ENDPATH**/ ?>
                          ...
                          <div class="card-body m-6 text-light ">
                              <form method="POST" action="<?php echo e(route('product_update', $pro->id)); ?>" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group row">
                                      <label for="name" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Product Code')); ?></label>
                                      <div class="col-md-6 ">
...
unset($__errorArgs, $__bag); ?>
                                  ...
                                  <div class="form-group row">
                                      <label for="image" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Product Image')); ?></label>
                                      <div class="col-md-6 ">
...
unset($__errorArgs, $__bag); ?>
                                      ...
                                      <div class="form-group row">
                                          <label for="name" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Category Name')); ?></label>
                                            <div class="col-md-6">
                                      ...
                                      <div class="form-group row">
                                          <label for="type_id" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Food Type')); ?></label>
                                            <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        <label for="stock_quantity" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Quantity')); ?></label>
                                        <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
                                      ...
                                      <div class="form-group row">
                                          <label for="stock_quantity" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Status')); ?></label>
                                          <div class="col-md-6">
...
<?php echo $__env->make('product.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\NewProject-master-master\NewProject-master-master\resources\views/product/product_list/p_updatepage.blade.php ENDPATH**/ ?>